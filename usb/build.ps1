...
function Install-ADK {
    ...
    Write-Host "  Installing WinPE add-on silently (this takes several minutes)..." -ForegroundColor Cyan
    $p = Start-Process -FilePath $peExe -ArgumentList "/quiet /norestart" -Wait -PassThru
